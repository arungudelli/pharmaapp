...
export function DocGenBill(formValues: any) {
  let docDefinition =
  {
    header: [
      '\n',
    ...
    content: [
      ...
      {
        text: `Bill Date: ${new Date(formValues.invoiceDate)?.toISOString().split('T')[0]}`,
      },
      {
        text: `Bill No: ${formValues.invoiceNumber}`,
      },
      '\n',
      {
        style: 'title',
